...
export default function MessagesPage() {
  ...
  if (loading || !user) {
    return <div className="flex h-screen bg-[#111111]" />;
  }
  ...
  return (
    <div className="flex h-screen bg-[#1c1c1e] text-[#e0e0e0] font-sans overflow-hidden">
      ...
      <main className="flex-1 flex h-full overflow-hidden relative z-10 md:pl-[72px] bg-[#1a1a1a]">
        
        {/* COLUMN 1: INBOXES (240px) */}
        <div className="w-[220px] bg-[#1a1a1a] border-r border-[#2a2a2a] flex flex-col h-full shrink-0">
          <div className="p-5 pb-2">
            <h2 className="text-[22px] font-bold text-white tracking-tight mb-6">Conversations</h2>
            
            <div className="flex flex-col gap-1 text-[13px] font-semibold text-[#a3a3a3]">
              <div className="flex items-center justify-between px-3 py-2 bg-[#2a2a2a]/50 text-white rounded-lg cursor-pointer">
                <div className="flex items-center gap-3">
                  <UserCircle2 className="w-4 h-4 text-[#e58c3a]" />
                  <span>Assigned to me</span>
                </div>
                <div className="w-5 h-5 rounded-full bg-[#e58c3a] text-white flex items-center justify-center text-[10px] font-bold">
                  8
                </div>
              </div>
              <div className="flex items-center justify-between px-3 py-2 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
              ...
              <div className="flex items-center px-3 py-2 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer transition-colors">
                <div className="flex items-center gap-3">
          ...
          <div className="mt-4 px-5">
            ...
            <div className="flex flex-col gap-0.5 text-[13px] text-[#a3a3a3] font-medium">
              <div className="flex items-center justify-between py-1.5 px-3 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer group">
                <span>Head Office</span>
                <span className="w-2 h-2 rounded-full bg-[#e58c3a] group-hover:scale-110 transition-transform"></span>
              </div>
              <div className="flex items-center py-1.5 px-3 relative cursor-pointer text-white">
                <div className="absolute left-0 top-1 bottom-1 w-[3px] bg-[#e58c3a] rounded-r-md"></div>
                <span>New Phone</span>
              </div>
              <div className="flex items-center py-1.5 px-3 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer">
                <span>Trade-ins</span>
              </div>
              <div className="flex items-center py-1.5 px-3 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer">
                <span>Repair</span>
              ...
              <div className="flex items-center justify-between py-1.5 px-3 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer mt-2">
                <span>Crowfoot Terrace</span>
                <ChevronDown className="w-3.5 h-3.5" />
              </div>
              <div className="flex items-center justify-between py-1.5 px-3 hover:bg-[#2a2a2a]/30 rounded-lg cursor-pointer">
        ...
        <div className="w-[340px] bg-[#1a1a1a] border-r border-[#2a2a2a] flex flex-col h-full shrink-0">
          <div className="p-5 border-b border-[#2a2a2a]">
            {/* Top Stats */}
            <div className="flex items-center justify-between text-[9px] text-[#8c8c8c] font-bold uppercase tracking-wider mb-5">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1 group">
                <input
                  ...
                  className="w-full bg-[#242424] border border-[#333] rounded-md py-2 pl-9 pr-3 text-[13px] text-white placeholder-[#666] focus:outline-none focus:border-[#444] transition-colors"
                />
                <Search className="w-4 h-4 text-[#666] absolute left-3 top-2.5" />
              </div>
              <button className="p-2 text-[#888] hover:text-white transition-colors bg-[#242424] rounded-md border border-[#333]">
                <SlidersHorizontal className="w-4 h-4" />
              </button>
              <button className="p-2 bg-[#e58c3a] text-white rounded-md hover:bg-[#d47b29] transition-colors shadow-lg shadow-orange-500/20">
                ...
                <div 
                  ...
                  className={`flex flex-col gap-2 p-3 rounded-xl cursor-pointer transition-colors border ${
                    isActive 
                      ...
                      : 'bg-transparent border-transparent hover:bg-[#202020]'
                  }`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col flex-1 min-w-0">
                      ...
                      <span className="text-[11px] text-[#e58c3a] font-medium mt-0.5">
                        {formatMessageTime(chat.lastMessageTime)}
                      </span>
                    </div>
                  </div>

                  <span className={`text-[12px] leading-snug truncate ${needsAccept ? 'text-white' : 'text-[#888]'}`}>
                    {chat.lastMessage || "Started a new conversation..."}
                  </span>

                  {needsAccept && (
                    <div className="flex items-center gap-2 mt-2">
                      <button className="flex-1 py-1.5 flex items-center justify-center gap-1.5 rounded-full border border-green-500/50 text-green-500 hover:bg-green-500/10 text-[12px] font-bold transition-colors">
                        <CheckCircle2 className="w-3.5 h-3.5" /> Accept
                      </button>
                      <button className="flex-1 py-1.5 flex items-center justify-center gap-1.5 rounded-full border border-red-500/50 text-red-500 hover:bg-red-500/10 text-[12px] font-bold transition-colors">
        ...
        <div className="flex-1 flex flex-col h-full bg-[#1c1c1c] relative z-0">
          {!activeRecipientProfile ? (
            ...
            <>
              {/* Header */}
              <div className="h-[72px] border-b border-[#2a2a2a] flex items-center justify-between px-6 shrink-0 bg-[#1a1a1a] z-10">
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2 text-[#666]">
                  <button className="p-2 hover:text-white hover:bg-[#2a2a2a] rounded-md transition-colors">
              ...
              <div className="bg-[#1e1e1e] border-b border-[#2a2a2a] py-2 px-6 text-center text-[11px] text-[#888] font-medium shrink-0">
              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
                <div className="flex justify-center mb-4">
                  <span className="text-[11px] text-[#666] font-medium">Live Chat Conversation with <span className="text-white">You</span> - Today, 23:36</span>
                </div>
                  ...
                  return (
                    <div key={msg.id || i} className={`flex max-w-[85%] ${isMe ? 'self-end' : 'self-start'} gap-3`}>
                      ...
                      <div className={`flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                        <div className="flex items-center gap-2 mb-1.5 text-[11px] text-[#888]">
                          {isMe ? (
                            <>
                              <span>Sent by Live Chat • {timeStr} • seen <strong className="text-white">You</strong></span>
                            </>
                          ) : (
                            <>
                              ...
                              <MessageSquare className="w-3 h-3 text-[#666]" />
                              <span>{timeStr}</span>
                            </>
                          )}
                        </div>
                        ...
                        <div className={`px-4 py-3 rounded-xl text-[13.5px] leading-relaxed max-w-full break-words border ${
                          isMe 
                            ? 'bg-[#2a2a2a] text-[#e0e0e0] border-[#333]' 
                            : 'bg-transparent border-[#333] text-[#e0e0e0]'
                        }`}>
                          {msg.content}
                        </div>
                      </div>
              ...
              <div className="p-4 bg-[#1a1a1a] border-t border-[#2a2a2a] shrink-0">
                <div className="flex items-center gap-4 mb-3 border-b border-[#2a2a2a] pb-3 text-[12px] font-semibold text-[#888]">
                  <button className="flex items-center gap-1.5 text-white bg-[#2a2a2a] px-3 py-1.5 rounded-md">
                    <MessageSquare className="w-4 h-4" /> Live Chat <ChevronDown className="w-3 h-3" />
                  </button>
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    <div className="w-8 h-4 bg-[#333] rounded-full relative cursor-pointer">
                      <div className="absolute left-0.5 top-0.5 w-3 h-3 bg-[#666] rounded-full"></div>
                    </div>
                  </div>
                </div>
                ...
                <form onSubmit={handleSendMessage} className="flex items-center gap-3">
                  <div className="flex-1 bg-transparent flex flex-col">
                    <input
                      ...
                      className="w-full bg-transparent text-[14px] text-white placeholder-[#666] outline-none py-2"
                    />
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div className="flex items-center">
                        <button type="button" className="p-2 text-[#e58c3a] hover:bg-[#2a2a2a] rounded-md transition-colors mr-2">
                          <Zap className="w-4 h-4" />
                        </button>
                        <div className="flex items-center">
                          <button 
                            ...
                            className="bg-[#e58c3a] text-white text-[13px] font-bold px-4 py-2 rounded-l-md hover:bg-[#d47b29] disabled:opacity-50 transition-colors"
                          >
                            Send
                          </button>
                          <button type="button" className="bg-[#d47b29] text-white px-2 py-2 rounded-r-md hover:bg-[#c36a18] border-l border-[#e58c3a] transition-colors">
        ...
        <div className="w-[280px] bg-[#1a1a1a] border-l border-[#2a2a2a] flex flex-col h-full shrink-0">
          {activeRecipientProfile ? (
            <>
              <div className="h-[72px] border-b border-[#2a2a2a] flex items-center justify-between px-5">
                <div className="flex items-center gap-3">
                  <img 
                    src={activeRecipientProfile.avatar_url || `https://api.dicebear.com/7.x/avataaars/svg?seed=${activeRecipientProfile.id}`}
                  ...
                  <div className="flex flex-col gap-3 text-[12px]">
                    <div>
                      <div className="flex items-center gap-1.5 text-white font-semibold mb-1">
                        <MessageSquare className="w-3.5 h-3.5" /> Chat • Active with You <CheckCircle2 className="w-3.5 h-3.5 text-[#666]" />
                      </div>
                    ...
                    <button className="text-[#e58c3a] font-medium text-left mt-1 hover:underline">Show more</button>
                  </div>
                </div>

                <div className="w-full h-[1px] bg-[#2a2a2a] mb-6"></div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-col gap-3 text-[12px]">
                    <div className="flex gap-2">
                      ...
                      <div className="flex flex-col gap-1.5 w-full text-[#a3a3a3]">
                        <div className="flex justify-between"><span>Phone</span> <span className="text-[#888]">Add</span></div>
                        <div className="flex justify-between text-white"><span>Whatsapp</span> <span>650-513-0514 <Star className="w-3 h-3 inline text-[#e58c3a]" /></span></div>
                    ...
                    <div className="flex gap-2 mt-2">
                      ...
                      <div className="flex flex-col gap-1.5 w-full text-[#a3a3a3]">
                        <div className="flex justify-between"><span>Email</span> <span className="text-[#888]">Add</span></div>
                    ...
                    <div className="flex items-center gap-2 text-[#a3a3a3] mt-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full bg-[#242424] border border-[#333] rounded-md py-2 pl-8 pr-3 text-[12px] text-white placeholder-[#666] outline-none"
                    />
            ...
            <div className="p-5 text-center text-[#555] text-sm mt-10">
