    ...
    <div className="relative z-10 w-full h-full flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col relative h-full overflow-y-auto no-scrollbar bg-[#D4F842]">
        ...
        <div className="flex flex-col md:flex-row flex-1 w-full">
          {/* Text Content Column */}
          <div className="flex-1 flex flex-col justify-center px-8 md:px-12 pb-8 md:pb-12 z-10 h-full relative">
            
            <div className="mt-auto flex flex-col justify-center">
              <h1 className="text-black text-[56px] md:text-[72px] lg:text-[84px] font-black leading-[0.85] tracking-tight mb-8" 
                  style={{ 
              ...
              <div className="w-20 h-4 bg-black mb-12" />

              <p className="font-sans text-black text-[11px] md:text-[12px] leading-relaxed max-w-sm font-bold mb-16">
            ...
            {/* Cryptos logo and pixel blocks at the bottom */}
            <div className="mt-auto flex items-end justify-between w-full pb-8">
              <div className="flex items-center gap-6">
                <span className="font-syncopate font-black text-black text-[32px] tracking-tighter lowercase">cryptos</span>
                <div className="flex flex-col gap-1 pb-1">
                   {/* Small pixel blocks like in the poster */}
                   <div className="w-5 h-5 bg-black ml-6" />
              ...
              {/* Bottom right pixel blocks before the black right section */}
              <div className="flex items-end gap-1">
                <div className="w-12 h-6 bg-black" />
                <div className="w-12 h-12 bg-black" />
                <div className="w-24 h-6 bg-black" />
                <div className="w-8 h-12 bg-black" />
              </div>
            </div>
          </div>
