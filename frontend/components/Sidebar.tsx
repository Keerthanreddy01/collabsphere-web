...
export default function Sidebar({ isSidebarOpen, setIsSidebarOpen, onMobileCreateClick }: any) {
  ...
  return (
    <div className="hidden md:flex shrink-0 w-[80px]">
      <motion.aside
        initial={false}
        ...
        className="fixed left-4 top-4 z-[60] flex h-[calc(100dvh-2rem)] flex-col bg-white dark:bg-[#0c0c0e] border border-gray-200 dark:border-white/[0.08] rounded-[24px] shadow-[0_8px_30px_rgba(0,0,0,0.10)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)] overflow-hidden"
      >
