        ...
        >
          <AnimatePresence mode="wait">
            {isExpanded ? (
              ...
              >
                <img src="/newlogo.png" alt="CollabSphere Logo" className="w-9 h-9 mr-3 rounded-full" />
              ...
              >
                <img src="/newlogo.png" alt="CollabSphere Logo" className="w-10 h-10 rounded-full" />
              </motion.div>
            )}
          </AnimatePresence>
        </Link>
